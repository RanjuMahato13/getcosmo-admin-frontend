...
export const deleteProdImg = createAsyncThunk(
  "product/delete-product-image",
  async (productId, publicId, thunkAPI) => {
    try {
      return await productService.deleteProductImg(productId, publicId);
    } catch (error) {
      return thunkAPI.rejectWithValue(error);
    }
  }
...
export const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(deleteProdImg.pending, (state) => {
        state.isLoading = true;
      })
      .addCase(deleteProdImg.fulfilled, (state, action) => {
        state.isLoading = false;
        state.isError = false;
        state.isSuccess = true;
        state.deletedImg = action.payload;
      })
      .addCase(deleteProdImg.rejected, (state, action) => {
        state.isLoading = false;
        state.isError = true;
        state.isSuccess = false;
        state.message = action.error;
      ...
      .addCase(getAProduct.fulfilled, (state, action) => {
        ...
        state.prodShades = action.payload.shades;
